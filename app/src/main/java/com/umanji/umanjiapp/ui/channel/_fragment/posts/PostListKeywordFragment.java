...
public class PostListKeywordFragment extends BaseChannelListFragment {
    private static final String TAG = "PostListKeywordFragment";
    private LinearLayout mlayout;

    public static PostListKeywordFragment newInstance(Bundle bundle) {
        PostListKeywordFragment fragment = new PostListKeywordFragment();
